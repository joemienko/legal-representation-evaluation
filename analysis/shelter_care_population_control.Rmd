...
mutate(
  ...
  id_calendar_dim_afcars_end_mod = case_when(
    ...
    id_calendar_dim_afcars_end == 0 & params$use_all_data == FALSE ~ params$control_censor_date,
  ...
  id_calendar_dim_observation_end = case_when(
    ...
    id_calendar_dim_observation_end == 99999999 & params$use_all_data == FALSE ~ params$control_censor_date, 
...
feather::write_feather(shelter_care_events_timed, "data/shelter_care_events_timed_control.feather")
